...
import type { ChildInfo, NextStep, Reminder } from "@/data/types";
...
export const ReminderPage = forwardRef<HTMLDivElement, { reminder: Reminder }>(
  function ReminderPage({ reminder: r }, ref) {
    return (
...
export const NextStepPage = forwardRef<
  HTMLDivElement,
  { nextStep: NextStep; childInfo: ChildInfo }
 ...
 */
export const BackCoverPage = forwardRef<HTMLDivElement, { childInfo: ChildInfo }>(
  function BackCoverPage({ childInfo: ci }, ref) {
  return (
    <div
      ref={ref}
      dir="rtl"
